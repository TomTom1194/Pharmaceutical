...
public class CapsuleSpecificationController : Controller
{
    private readonly ICapsuleSpecificationService _service;
    private readonly IProductService _productService;

    public CapsuleSpecificationController(ICapsuleSpecificationService service, IProductService productService)
    {
        _service = service;
    ...
    public async Task<IActionResult> Create(int productId)
    {
        ...
        return View(new CapsuleSpecification { ProductId = productId });
    }
    ...
    [HttpPost]
    public async Task<IActionResult> Edit(int id, CapsuleSpecification spec)
    {
        if (!ModelState.IsValid)
        {
            ViewBag.Product = await _productService.GetById(id);
